# Set some sane defaults for the turtlebot murom launch environment
...
: ${MUROM_MAP_FILE:=`rospack find turtlebot_navigation`/maps/willow-2010-02-18-0.10.yaml}

# Exports
export MUROM_MAP_FILE
